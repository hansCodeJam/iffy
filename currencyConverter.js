...
function main() {
  ...
  let userCurrency = readline.question('What is your current currency? Type "USD", "EUR", "JPY", "GPB", "AUD"\n')
  let currency = readline.question('What currency would like to convert to? Type "USD" , "EUR", "JPY", "GDP", "AUD" \n')
